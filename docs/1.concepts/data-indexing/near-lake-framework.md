...
Ease of local development | Advanced<br />(localnet is a good option, but testing on testnet/mainnet is too heavy) | **Easy**<br />(see [tutorials](/build/near-data-infrastructure/lake-framework/lake-frameworknear-lake-state-changes-indexer))
...
See [Tutorials page](/build/near-data-infrastructure/lake-framework/lake-frameworknear-lake-state-changes-indexer)
