...
We encourage you to learn more about the [Lake Indexer project](/tools/realtime#near-lake-indexer). Please, proceed to [Tutorials](/build/near-data-infrastructure/lake-framework/lake-frameworknear-lake-state-changes-indexer) section to learn how to build an indexer on practice.
